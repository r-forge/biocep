...
public class FreeMindApplet extends AppletBase implements FreeMindMain {
    ...
    public FreeMindApplet(HashMap<String, String> customParams) {
		super(customParams);
        mFreeMindCommon = new FreeMindCommon(this);
        Resources.createInstance(this);
    ...
    public String getProperty(String key) {
    	String result=null;
    	if (getParameter(key)!=null) result=getParameter(key);
    	else result=userProps.getProperty(key);
    	return result;
    }
    ...
    if(resourceURL == null || ! resourceURL.getProtocol().equals("jar")) return null;
    return resourceURL;
    }
