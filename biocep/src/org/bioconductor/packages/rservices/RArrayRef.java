 ...
 */
public class RArrayRef extends RArray implements mapping.ReferenceInterface, mapping.StandardReference, Externalizable {
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RArrayRef))
			return false;
		return ((RArrayRef) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0]
				&& ((RArrayRef) inputObject)._slotsPath.equals(_slotsPath);
	}

	public String toString() {
		StringBuffer result = new StringBuffer();
		try {
			result.append("A Reference to an object of Class \"RArray\" on the R servant <"
