...
public class Preferences {
	...
	// CONSTANTS
	// =========================================================================
	protected static final String CONFIG_FILENAME = "/org/pf/joi/joi.properties";
	...
	protected static final int DEFAULT_DOUBLE_CLICK_MODE = InspectionWindowController.INSPECT_IN_NEW_WINDOW;
	protected static final int DEFAULT_MIDDLE_BUTTON_MODE = InspectionWindowController.INSPECT_IN_NEW_TAB;
	...
	static final String[] MODIFIER_OPTIONS = { OPT_STATIC_DEFAULT, OPT_FINAL_DEFAULT, OPT_TRANSIENT_DEFAULT,
			OPT_PRIVATE_DEFAULT, OPT_PROTECTED_DEFAULT, OPT_PUBLIC_DEFAULT, OPT_PACKAGE_DEFAULT };
	...
	protected void initialize() {
		...
		try {
			config = PropertyFileLoader.loadProperties(Preferences.class.getResourceAsStream(CONFIG_FILENAME));
		} catch (Exception e) {
			e.printStackTrace();
		}
		if (config == null) {
