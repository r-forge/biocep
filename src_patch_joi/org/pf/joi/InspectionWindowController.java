...
public class InspectionWindowController implements ActionListener, WindowListener {
	...
	protected void start(BasicInspector inspector) {
		...
		this.getMainFrame().getContentPane().setPreferredSize(new Dimension(400, 400));
	...
	protected void displayAboutInfo() {
		JOptionPane.showMessageDialog(this.getMainFrame().getContentPane(), Inspector.getAboutInfoText(), "About "
				+ Inspector.PROG_ID, JOptionPane.INFORMATION_MESSAGE);
	} // displayAboutInfo() 
	...
	protected JMenu createSubmenuWindow() {
		...
		// TODO menuItem = this.createMenuItem(	"Close Tab", actCloseTab ) ;
		// menu.add( menuItem ) ;
