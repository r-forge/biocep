...
<object align="center" height=98% width=98%
	...
	<object align="center" height=98% width=98%
		...
		<param name="archive"
			value="appletlibs/RJB.jar,appletlibs/commons-httpclient-3.1-rc1.jar,appletlibs/commons-codec-1.3.jar,appletlibs/commons-logging-1.1.1.jar,appletlibs/mapping.jar,appletlibs/idw-gpl.jar,appletlibs/PDFRenderer.jar,appletlibs/jeditmodes.jar,appletlibs/jedit.jar,appletlibs/pf-joi-full.jar,appletlibs/OpenXLS.jar,appletlibs/servlet-api-2.5-6.1.8.jar,appletlibs/jsp-api-2.1.jar,appletlibs/jsp-2.1.jar,appletlibs/jetty-6.1.8.jar,appletlibs/jetty-util-6.1.8.jar,appletlibs/activation.jar,appletlibs/mail.jar,appletlibs/htmlparser.jar,appletlibs/JRI.jar,appletlibs/derbyclient.jar,appletlibs/ganymed-ssh2.jar,appletlibs/batik-anim.jar,appletlibs/batik-awt-util.jar,appletlibs/batik-bridge.jar,appletlibs/batik-css.jar,appletlibs/batik-dom.jar,appletlibs/batik-svggen.jar,appletlibs/batik-ext.jar,appletlibs/batik-extension.jar,appletlibs/batik-gui-util.jar,appletlibs/batik-gvt.jar,appletlibs/batik-parser.jar,appletlibs/batik-script.jar,appletlibs/batik-svg-dom.jar,appletlibs/batik-swing.jar,appletlibs/batik-util.jar,appletlibs/batik-xml.jar,appletlibs/js.jar,appletlibs/xml-apis.jar,appletlibs/xml-apis-ext.jar,appletlibs/edtftpj.jar,appletlibs/jython.jar,appletlibs/swing-layout-1.0.3.jar,appletlibs/groovy-all-1.5.4.jar,appletlibs/freemindbrowser.jar,appletlibs/biocep-doc.jar">
