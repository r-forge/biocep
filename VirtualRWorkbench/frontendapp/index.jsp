...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
		...
		<object
			...
			<PARAM NAME = ARCHIVE VALUE = "appletlibs/RJB.jar,appletlibs/commons-httpclient-3.1-rc1.jar,appletlibs/commons-codec-1.3.jar,appletlibs/commons-logging-1.1.jar,appletlibs/log4j-1.2.14.jar,appletlibs/mapping.jar,appletlibs/idw-gpl.jar,appletlibs/jeditmodes.jar,appletlibs/jedit.jar,appletlibs/pf-joi-full.jar,appletlibs/OpenXLS.jar,appletlibs/webserver.jar,appletlibs/htmlparser.jar,appletlibs/servlet-api.jar,appletlibs/JRI.jar,appletlibs/derbyclient.jar" >
			...
			<comment>
				<embed type = "application/x-java-applet;version=1.5" 
					...
					ARCHIVE = "appletlibs/RJB.jar,appletlibs/commons-httpclient-3.1-rc1.jar,appletlibs/commons-codec-1.3.jar,appletlibs/commons-logging-1.1.jar,appletlibs/log4j-1.2.14.jar,appletlibs/mapping.jar,appletlibs/idw-gpl.jar,appletlibs/jeditmodes.jar,appletlibs/jedit.jar,appletlibs/pf-joi-full.jar,appletlibs/OpenXLS.jar,appletlibs/webserver.jar,appletlibs/htmlparser.jar,appletlibs/servlet-api.jar,appletlibs/JRI.jar,appletlibs/derbyclient.jar" 					
					WIDTH = "<%=width%>" 
					HEIGHT = "<%=height%>" 
					scriptable = false 
