 ...
 */
public class RIntegerObjectName extends RInteger implements ObjectNameInterface {
	private String _name; 
	private String _env;
	
	public RIntegerObjectName() {
	}

	public RIntegerObjectName(String name) {
		this._name = name;
		this._env = ".GlobalEnv";
	}

	public RIntegerObjectName(String environment, String name) {
		this._name = name;
