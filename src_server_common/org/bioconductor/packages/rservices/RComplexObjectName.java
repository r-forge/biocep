 ...
 */
public class RComplexObjectName extends RComplex implements ObjectNameInterface{
	private String _name; 
	private String _env;
	
	public RComplexObjectName() {
	}

	public RComplexObjectName(String name) {
		this._name = name;
		this._env = ".GlobalEnv";
	}

	public RComplexObjectName(String environment, String name) {
		this._name = name;
	...
	public String toString() {
		return "RComplexObjectName:"+_env+"$"+_name;
	}
