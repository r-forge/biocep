 ...
 */
public class RRawObjectName extends RRaw implements ObjectNameInterface {
	private String _name; 
	private String _env;
	
	public RRawObjectName() {
	}

	public RRawObjectName(String name) {
		this._name = name;
		this._env = ".GlobalEnv";
	}

	public RRawObjectName(String environment, String name) {
		this._name = name;
