 ...
 */
public class RListRef extends RList implements mapping.ReferenceInterface, mapping.StandardReference, Externalizable {
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RListRef))
			return false;
		return ((RListRef) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0]
				&& ((RListRef) inputObject)._slotsPath.equals(_slotsPath);
	}
	...
	public String toString() {
		...
		try {
			result.append("A Reference to an object of Class \"RList\" on the R servant <" + _assignInterface.getName()
					+ ">  [" + _rObjectIdHolder[0] + "/" + _slotsPath + "]\n");
