 ...
 */
public class RNumericRef extends RNumeric implements mapping.ReferenceInterface, mapping.StandardReference,
		Externalizable {
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RNumericRef))
			return false;
		return ((RNumericRef) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0]
				&& ((RNumericRef) inputObject)._slotsPath.equals(_slotsPath);
	}
	...
	public String toString() {
		...
		try {
			result.append("A Reference to an object of Class \"RNumeric\" on the R servant <"
