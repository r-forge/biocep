 ...
 */
public class RNumericObjectName extends RNumeric implements  ObjectNameInterface {
	private String _name; 
	private String _env;
	
	public RNumericObjectName() {
	}

	public RNumericObjectName(String name) {
		this._name = name;
		this._env = ".GlobalEnv";
	}

	public RNumericObjectName(String environment, String name) {
		this._name = name;
	...
	public String toString() {
		return "RNumericObjectName:"+_env+"$"+_name;
	}
