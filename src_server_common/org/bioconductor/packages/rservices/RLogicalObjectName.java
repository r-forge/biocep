 ...
 */
public class RLogicalObjectName extends RLogical implements ObjectNameInterface {
	private String _name; 
	private String _env;
	
	public RLogicalObjectName() {
	}

	public RLogicalObjectName(String name) {
		this._name = name;
		this._env = ".GlobalEnv";
	}

	public RLogicalObjectName(String environment, String name) {
		this._name = name;
	...
	public String toString() {
		return "RLogicalObjectName:"+_env+"$"+_name;
	}
