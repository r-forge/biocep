 ...
 */
public class RDataFrameRef extends RDataFrame implements mapping.ReferenceInterface, mapping.StandardReference,
		Externalizable {
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RDataFrameRef))
			return false;
		return ((RDataFrameRef) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0]
				&& ((RDataFrameRef) inputObject)._slotsPath.equals(_slotsPath);
	}

	public String toString() {
		StringBuffer result = new StringBuffer();
		try {
			result.append("A Reference to an object of Class \"RDataFrame\" on the R servant <"
