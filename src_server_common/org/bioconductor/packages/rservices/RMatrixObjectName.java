 ...
 */
public class RMatrixObjectName extends RMatrix implements ObjectNameInterface {
	private String _name; 
	private String _env;
	
	public RMatrixObjectName() {
	}

	public RMatrixObjectName(String name) {
		this._name = name;
		this._env = ".GlobalEnv";
	}

	public RMatrixObjectName(String environment, String name) {
		this._name = name;
	...
	public String toString() {
		return "RMatrixObjectName:"+_env+"$"+_name;
	}
