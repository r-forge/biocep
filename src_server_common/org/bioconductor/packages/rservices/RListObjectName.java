 ...
 */
public class RListObjectName extends RList implements ObjectNameInterface{
	private String _name; 
	private String _env;
	
	public RListObjectName() {
	}

	public RListObjectName(String name) {
		this._name = name;
		this._env = ".GlobalEnv";
	}

	public RListObjectName(String environment, String name) {
		this._name = name;
	...
	public String toString() {
		return "RListObjectName:"+_env+"$"+_name;
	}
