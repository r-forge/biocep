...
public class RRawRef extends RRaw implements mapping.ReferenceInterface, mapping.StandardReference, Externalizable {
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RRawRef))
			return false;
		return ((RRawRef) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0]
				&& ((RRawRef) inputObject)._slotsPath.equals(_slotsPath);
	}

	public String toString() {
		StringBuffer result = new StringBuffer();
		try {
			result.append("A Reference to an object of Class \"RRaw\" on the R servant <" + _assignInterface.getName()
