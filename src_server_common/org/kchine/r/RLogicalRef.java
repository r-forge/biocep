 ...
 */
public class RLogicalRef extends RLogical implements org.kchine.r.server.ReferenceInterface, org.kchine.r.server.StandardReference, Externalizable {
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RLogicalRef))
			return false;
		return ((RLogicalRef) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0] && ((RLogicalRef) inputObject)._slotsPath.equals(_slotsPath);
	}
	...
	public String toString() {
		...
		try {
			result.append("A Reference to an object of Class \"RLogical\" on the R servant <" + _assignInterface.getName() + ">  [" + _rObjectIdHolder[0] + "/"
					+ _slotsPath + "]\n");
