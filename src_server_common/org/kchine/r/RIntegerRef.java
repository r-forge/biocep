 ...
 */
public class RIntegerRef extends RInteger implements org.kchine.r.server.ReferenceInterface, org.kchine.r.server.StandardReference, Externalizable {
	...
	public RIntegerRef(long rObjectId, String slotsPath) {
		super();
		_rObjectIdHolder = new long[1];
	...
	public RIntegerRef(long[] rObjectIdHolder, String slotsPath) {
		super();
	...
	public int[] getValue() {
		try {
			return _assignInterface.getValueIntArray(_rObjectIdHolder[0], _slotsPath);
		} catch (Exception e) {
			throw new RuntimeException(Utils.getStackTraceAsString(e));
		}
	}
	...
	public void setValue(int[] value) {
		try {
			_rObjectIdHolder[0] = _assignInterface.setValueIntArray(_rObjectIdHolder[0], _slotsPath, value);
		} catch (Exception e) {
			throw new RuntimeException(Utils.getStackTraceAsString(e));
		}
	}
