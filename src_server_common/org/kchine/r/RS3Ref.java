 ...
 */
public class RS3Ref extends RS3 implements org.kchine.r.server.ReferenceInterface, org.kchine.r.server.StandardReference, Externalizable {
	...
	public RS3Ref(long rObjectId, String slotsPath) {
		super();
		_rObjectIdHolder = new long[1];
	...
	public RS3Ref(long[] rObjectIdHolder, String slotsPath) {
		super();
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RListRef))
			return false;
		return ((RS3Ref) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0] && ((RS3Ref) inputObject)._slotsPath.equals(_slotsPath);
	}
	...
	public String toString() {
		...
		try {
			result.append("A Reference to an object of Class \"RS3\" on the R servant <" + _assignInterface.getName() + ">  [" + _rObjectIdHolder[0] + "/"
					+ _slotsPath + "]\n");
