 ...
 */
public class RMatrixRef extends RMatrix implements org.kchine.r.server.ReferenceInterface, org.kchine.r.server.StandardReference, Externalizable {
	...
	public boolean equals(Object inputObject) {
		if (inputObject == null || !(inputObject instanceof RMatrixRef))
			return false;
		return ((RMatrixRef) inputObject)._rObjectIdHolder[0] == _rObjectIdHolder[0] && ((RMatrixRef) inputObject)._slotsPath.equals(_slotsPath);
	}
	...
	public String toString() {
		...
		try {
			result.append("A Reference to an object of Class \"RMatrix\" on the R servant <" + _assignInterface.getName() + ">  [" + _rObjectIdHolder[0] + "/"
					+ _slotsPath + "]\n");
