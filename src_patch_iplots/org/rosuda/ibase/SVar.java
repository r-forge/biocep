 ...
 * @version $Id: SVar.java 2822 2007-08-21 20:26:21Z urbanek $
 */
public abstract class SVar extends Notifier implements SVarInterface 
{
    ...
    transient private SVarInterfaceRemoteImpl svarRemote;
    ...
    public SVar(String Name, boolean iscat)
    {
        ...
        selected=false;
        try {
        	svarRemote=new SVarInterfaceRemoteImpl(this);
    ...
    */
    ...
    public abstract int[] getRanked(SMarkerInterface m, int markspec);
