...
public class SCatSequence extends Notifier implements Serializable{
    ...
    public String toString() {
        return "SCatSequence(var=\""+((v==null)?"<null>":v.getName())+ "\",cats="+cats+((seqToCat==null)?",straight":",mapped")+")";
    }
}
