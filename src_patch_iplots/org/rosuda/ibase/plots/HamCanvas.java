 ...
 * @version $Id: HamCanvas.java 2440 2006-05-23 13:19:03Z wichtreyt $
 */
public class HamCanvas extends BaseCanvas {
    ...
    public void updateObjects() {
        ...
        if (pp==null) {
            ...
            int j=0;
            while (j<v.length-1) {
                SVarInterface v1=v[j];
                SVarInterface v2=v[j+1];
    ...
    public SVarInterface getData(int id) { return (id>=0 && id<v.length)?v[id]:null; }
}
