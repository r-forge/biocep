...
public class ScatterCanvas extends BaseCanvas {
    ...
    public ScatterCanvas(final int gd, final Frame f, final SVarInterface v1, final SVarInterface v2, final SMarkerInterface mark) {
	super(gd,f,mark);
    ...
    public SVarInterface getData(final int id) { return (id<0||id>1)?null:v[id]; }
