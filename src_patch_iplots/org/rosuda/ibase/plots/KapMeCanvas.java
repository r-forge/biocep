...
public class KapMeCanvas extends BaseCanvas {
    ...
    public KapMeCanvas(int gd, Frame f, SVarInterface time, SVarInterface event, SMarkerInterface mark) {
        super(gd,f,mark);
    ...
    public SVarInterface getData(int id) {
        switch(id){
            case 0:
                return vTime;
            case 1:
