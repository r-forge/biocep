...
/** implementation of maps (uses {@link BaseCanvas})
    @version $Id: MapCanvas.java 2296 2006-04-26 14:34:10Z wichtreyt $
*/
public class MapCanvas extends BaseCanvas
{
    ...
    public MapCanvas(String title) {super(title);}
    
    public MapCanvas(int gd, Frame f, SVarInterface mv, SMarkerInterface mark) {
        super(gd,f,mark);
    ...
    public SVarInterface getData(int id) { return (id==0)?v:null; }
}
