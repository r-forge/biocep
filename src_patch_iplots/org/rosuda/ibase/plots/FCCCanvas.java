...
/** color coded fluctuation diagram (dirty hack)
    @version $Id: FCCCanvas.java 2250 2006-04-18 10:10:13Z goubermana $
*/
public class FCCCanvas extends FluctCanvas {
    SVarInterface ccv;
    public FCCCanvas(int gd, Frame f, SVarInterface v1, SVarInterface v2, SMarkerInterface mark, SVarInterface ccvar) {
