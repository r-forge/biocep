 ...
 * @version $Id: BarCanvas.java 2799 2007-06-13 08:15:02Z wichtrey $
 */
public class BarCanvas extends BaseCanvas {
    ...
    public BarCanvas(final int gd, final Frame f, final SVarInterface var, final SMarkerInterface mark, final SVarInterface wvar) {
	super(gd,f,mark);
    ...
    public BarCanvas(final int gd, final Frame f, final SVarInterface var, final SMarkerInterface mark) { this(gd,f,var,mark,null); };
    
    public SVarInterface getData(final int id) { return (id==0)?v:((id==1)?weight:null); }
