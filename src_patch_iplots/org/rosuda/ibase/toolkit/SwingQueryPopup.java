...
public class SwingQueryPopup implements MouseListener, QueryPopup {
    ...
    public SwingQueryPopup(SWINGGraphicsDevice gd, final Window ow, final SVarSetInterface vs, final String ct) {
        this(gd, ow,vs,ct,-1,-1);
    }

    public SwingQueryPopup(SWINGGraphicsDevice gd, final Window ow, final SVarSetInterface uvs, final String ct, final int w, final int cid)
    {
    	grdev=gd;
    	vs = uvs;
