...
@version $Id: PlotPrimitive.java 2540 2006-06-17 09:45:53Z wichtreyt $
*/
public interface PlotPrimitive {
    ...
    void paint(PoGraSS g, int orientation, SMarkerInterface m);

    /** paint the selection */
    void paintSelected(PoGraSS g, int orientation, SMarkerInterface m);
    ...
    void setMark(SMarkerInterface m, boolean setTo);
    ...
    double getMarkedProportion(SMarkerInterface m, int mark);
