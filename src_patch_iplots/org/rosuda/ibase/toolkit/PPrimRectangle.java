...
//
//  $Id: PPrimRectangle.java 2554 2006-06-20 18:55:25Z urbaneks $
...
public class PPrimRectangle extends PPrimBase {
    ...
    protected void brushRect(PoGraSS g, SMarkerInterface m, int orientation, Rectangle r, Color borderColor) {
        int rX=r.x,rY=r.y,rW=r.width,rH=r.height;
        final double totW=rW;
        final double totH=rH;
        int mark=-1;
