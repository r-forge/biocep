...
public class PPrimBox extends PPrimBase {
    ...
    public void paint(final org.rosuda.pograss.PoGraSS g, final int orientation, final SMarkerInterface m) {
        int i;
        int ox,oy;
        switch(orientation){
            case 0:
    ...
    public void paintSelected(final org.rosuda.pograss.PoGraSS g, final int orientation, final org.rosuda.ibase.SMarkerInterface m) {
