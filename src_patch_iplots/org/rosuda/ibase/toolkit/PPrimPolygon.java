 ...
 * @version $Id: PPrimPolygon.java 2659 2006-10-25 16:40:07Z urbaneks $
 */
public class PPrimPolygon extends PPrimBase {
    ...
    /** paint the primitive */
    public void paint(final PoGraSS g, final int orientation, final SMarkerInterface m) {
        if (pg==null) return;
    ...
    public void paintSelected(final PoGraSS g, final int orientation, final SMarkerInterface m) {
        if (pg==null) return;
    ...
    private void paintPolygon(final PoGraSS g, final int orientation, final SMarkerInterface m, boolean paintingSelected, final Color colOutline, final Color colFill) {
        if(fill){
            if (colFill!=null)
                g.setColor(colFill);
            else
