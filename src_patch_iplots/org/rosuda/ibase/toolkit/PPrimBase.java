...
public abstract class PPrimBase implements PlotPrimitive {
    ...
    public void setMark(final SMarkerInterface m, final boolean setTo) {
        if (ref!=null) {
            int j=0;
    ...
    public double getMarkedProportion(final SMarkerInterface m, final int mark) {
    ...
    public double getMarkedProportion(final SMarkerInterface m, final int mark, final boolean dropPrimary) {
        if (ref!=null && m!=null) {
    ...
    protected double getRelativeMarkedProportion(SMarkerInterface m, int mark) {
        double total=0;
        double selected=0;
