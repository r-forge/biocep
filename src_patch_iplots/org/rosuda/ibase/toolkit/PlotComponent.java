...
//		System.out.println("PlotComponent: repaint()");
	...
	public QueryPopup newQueryPopup(final Window win, final SVarSetInterface vs, final String ct, final int w, final int cid) {
	...
	public QueryPopup newQueryPopup(final Window win, final SVarSetInterface vs, final String ct) {
