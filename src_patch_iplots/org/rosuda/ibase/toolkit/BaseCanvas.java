 ...
 *
 * @version $Id: BaseCanvas.java 2832 2007-09-07 16:57:52Z urbanek $
 */
...
//        setUpdateRoot(4);
	...
	if (M_EXPORTCASES.equals(cmd)) {
	    ...
	    if(vars.size()>0) {
		final SVarInterface[] v = new SVarInterface[vars.size()];
		vars.toArray(v);
		try {
    ...
    public void addYLabels(PoGraSS g, Axis axis, SVarInterface sVar, boolean ticks, boolean abbreviate) {
    ...
    private void addYLabels_internal(PoGraSS g, Axis axis, SVarInterface sVar, boolean ticks, boolean abbreviate) {
