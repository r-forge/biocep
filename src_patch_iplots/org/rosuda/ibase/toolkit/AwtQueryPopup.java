...
/** query popup
 * @version $Id: AwtQueryPopup.java 2570 2006-07-03 22:05:24Z urbaneks $
 */
...
public class AwtQueryPopup extends AWTGraphicsDevice implements MouseListener, QueryPopup {
    class QPCanvas extends AWTGraphicsDevice {
        ...
        QPCanvas(final Window wn, final SVarSetInterface uvs, final String ct, final int w, final int cid) {
    ...
    public AwtQueryPopup(final Window ow, final SVarSetInterface vs, final String ct, final int w, final int cid) {
    	if(ct==null) return;
    ...
    public AwtQueryPopup(final Window ow, final SVarSetInterface vs, final String ct) {
        this(ow,vs,ct,-1,-1);
    }
