...
public class Mode {
	...
	public void init() {
		try {
			...
			if (filenameGlob != null && filenameGlob.length() != 0) {
				filenameRE = new RE(MiscUtilities.globToRE(filenameGlob), RE.REG_ICASE);
			}

			String firstlineGlob = (String) getProperty("firstlineGlob");
			if (firstlineGlob != null && firstlineGlob.length() != 0) {
				firstlineRE = new RE(MiscUtilities.globToRE(firstlineGlob), RE.REG_ICASE);
			}
	...
	public void setProperties(Hashtable props) {
		...
		String filename = (String) this.props.get("file").toString();
		this.props = props;
