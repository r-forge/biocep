...
public class OpenPluginViewDialog extends JDialog {
	...
	public static void main(String[] args) throws Exception {
		final File pluginsDir = new File(new File(ServerManager.INSTALL_DIR).getAbsoluteFile() + "/plugins");
		if (!pluginsDir.exists())
			pluginsDir.mkdirs();
		final File[] files =new File[]{new File("F:/Documents and Settings/Karim Chine/Bureau/AA.zip")};
		...
		//Vector<PluginViewDescriptor> result = getPluginViews("E:/workspace/distrib/plugins/netbeans/SimplePlugin/dist/SimplePlugin.jar");
		//System.out.println(result);

		// Vector<PluginViewDescriptor> result =
		// getPluginViews("E:/workspace/distrib/plugins/netbeans/SimplePlugin/build/classes/");
		// Vector<PluginViewDescriptor> result =
		// getPluginViews("E:/workspace/distrib/plugins/netbeans/SimplePlugin/dist/SimplePlugin.jar");
		// System.out.println(result);

		// Vector<PluginViewDescriptor> result =
		// getPluginViews("http://biocep-distrib.r-forge.r-project.org//examples/SimplePlugin.jar");
		// System.out.println(result);
