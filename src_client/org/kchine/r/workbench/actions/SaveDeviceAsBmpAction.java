...
public class SaveDeviceAsBmpAction extends AbstractAction {

	RGui _rgui;

	public SaveDeviceAsBmpAction(RGui rgui) {
		super("Save as BMP");
		_rgui = rgui;
	}
	...
	public void actionPerformed(final ActionEvent e) {
		...
		chooser.setDialogTitle("Save Graphics as BMP");
			...
			new Thread(new Runnable() {
				public void run() {
					try {
						...
						byte[] result = panel.getGdDevice().getBmp();
