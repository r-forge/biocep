 ...
 */
public class SaveDeviceAsJavaJpgAction extends AbstractAction {

	RGui _rgui;

	public SaveDeviceAsJavaJpgAction(RGui rgui) {
		super("Save as Java JPEG");
		_rgui = rgui;
	}
	...
	public void actionPerformed(final ActionEvent e) {
		...
		chooser.setDialogTitle("Save Graphics as Java JPEG");
			...
			new Thread(new Runnable() {
				public void run() {
					try {
						...
						byte[] result = panel.getGdDevice().getFromImageIOWriter("jpeg");
